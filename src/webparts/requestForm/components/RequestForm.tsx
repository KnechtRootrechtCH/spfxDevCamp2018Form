...
import {IRequestForm} from "../Model/IRequestForm";
...
IRequestForm > {
  constructor() {
    ...
    this.handleTitle = this
      .handleTitle
      .bind(this);
    this.handleDesc = this
      .handleDesc
      .bind(this);
    this._onCheckboxChange = this
      ._onCheckboxChange
      .bind(this);
    this._onRenderFooterContent = this
      ._onRenderFooterContent
      .bind(this);
    this.createItem = this
      .createItem
      .bind(this);
    this.onTaxPickerChange = this
      .onTaxPickerChange
      .bind(this);
    this._getManager = this
      ._getManager
      .bind(this);
    this.state = {
      name: "",
            ...
            <div
              ...
              <div className="ms-Grid-col ms-u-sm8 block">
                <TextField
                  ...
                  errorMessage={(this.state.name.length === 0 && this.state.onSubmission === true)
                  ? this.state.required
                  : ""}/>
              </div>
              <div className="ms-Grid-col ms-u-sm4 block">
              ...
              <div className="ms-Grid-col ms-u-sm8 block">
                <TaxonomyPicker
                  ...
                  termsetNameOrID="4b37e6c4-3265-4fb7-a230-49922c392cda"
                ...
                <p
                  className={(this.state.termKey === undefined && this.state.onSubmission === true)
                  ? styles.fontRed
                  : styles.hideElement}>This is required</p>
              </div>
              <div className="ms-Grid-col ms-u-sm4 block">
              ...
              <div className="ms-Grid-col ms-u-sm8 block">
                <PeoplePicker context={this.props.context} titleText=" " personSelectionLimit={1} groupName={""} // Leave this blank in case you want to filter from all users
                  showtooltip={false} isRequired={true} disabled={false} selectedItems={this._getManager} errorMessage={(this.state.userManagerIDs.length === 0 && this.state.onSubmission === true)
                  ? this.state.required
              ...
              <div className="ms-Grid-col ms-u-sm11 block">
                ...
                <p
                  className={(this.state.termnCond === false && this.state.onSubmission === true)
                  ? styles.fontRed
                  : styles.hideElement}>Please check the Terms & Condition</p>
              </div>
              <div className="ms-Grid-col ms-u-sm6 block"></div>
  ...
  private validateForm() : void {
    ...
    /*if(this.state.userManagerIDs.length === 0)
  {
    console.log(ReactDOM.findDOMNode(this).getElementsByClassName(`${styles.hideElementManager}`));
    ReactDOM.findDOMNode(this).getElementsByClassName(`${styles.hideElementManager}`)[0].setAttribute("style","display:block");
    allowCreate = false;
  }*/
  ...
  private createItem() : void {
    ...
    sp
      .web
      .lists
      .getByTitle("Employee Registeration")
      .items
      .add({
